...
export function createFlexible(options: CreateFlexibleOptions = {}) {
  ...
  function setRootFontSize(emit?: boolean) {
    if (record.root == null) record.root = document.documentElement.style.fontSize
  ...
  function setBodyFontSize() {
    if (document.body) {
      if (record.body == null) record.body = document.body.style.fontSize
